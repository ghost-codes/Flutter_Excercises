                         ...
                         children: <Widget>[
                           InkWell(
                             ...
                             child: Container(
                               ...
                               style:TextStyle(color: Colors.white))), //TODO: Style Theme it!
                             ),
                           ),
                           Text("$_lengthOfLoan",
                           style: Theme.of(context).textTheme.headline5,), //TODO: Style Theme it!
                           InkWell(
                               onTap: () {
                                  setState(() {
                             ...
                             child: Container(
                               ...
                               child: Center(child:Text("+",
                                   style:TextStyle(color: Colors.white))) //TODO: theme this!
                   ...
                   Column(
                      children: <Widget>[
                        Slider(
                            min: 0.0,
                            max: 10.0,
                            activeColor: Theme.of(context).accentColor, //TODO: Theme this!
