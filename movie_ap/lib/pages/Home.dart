...
import 'package:movie_ap/pages/MovieListDetails.dart';
...
class _HomeState extends State<Home> {
  ...
  List<Movie> listOfMovie = List<Movie>();
  ...
  void initState() {
    ...
    _movies.forEach((element) {
      listOfMovie.add(Movie.fromJson(element));
    });
  }
        ...
        child: ListView.builder(
          itemCount: listOfMovie.length,
            ...
            return Stack(children: [
              ...
              buildCard(listOfMovie[index],context),
              Container(
                height: 100,
                width: 100,
              ...
              //         decoration: BoxDecoration(
              //           image: DecorationImage(
              //             image: NetworkImage(listOfMovie[index].images[0]),
              //             fit: BoxFit.cover
              //           )
              //         ),
              //       ),
              //     ),
              //     title: Text(listOfMovie[index].title),
              //     trailing: Text("..."),
              //     onTap: (){
              //       Navigator.push(
              //         context,
              ...
              //             movie_name:listOfMovie.elementAt(index).title,
              //             movie: listOfMovie[index],)
              //         )
              //       );
              //     },
              //   )
    ...
    return InkWell(
      ...
      onTap: ()=>{
          Navigator.push(context,MaterialPageRoute(
            builder: (context)=> MoviesListViewDetails(movie: movie,)
          ),
          )
      },
    );
