            ...
            builder: (context, appState, _)=> Column(
              ...
              children: [
                ...
                if(appState.loginState == ApplicationLoginState.loggedIn)...[
                  ...
                  Header('Discusion'),
                  GuestBook(addMessage: (String message) =>
...
class ApplicationState extends ChangeNotifier{
  ...
  Future<void> init() async{
    ...
    .where('attending', isEqualTo: true).snapshots()
    .listen((snapshot){
    ...
    FirebaseAuth.instance.userChanges().listen((user) {
      if(user != null){
        ...
        _guestBookSubscription = FirebaseFirestore.instance.collection('guestbook')
        .orderBy('timestamp', descending:true).snapshots()
        .listen((snapshot) {
          _guestBookMessages = [];
          snapshot.docs.forEach((document) {
            _guestBookMessages.add(
              GuestBookMessage(name: document.data()['name'] , message: document.data()['text']),
            );
          });
          notifyListeners();
        });
  ...
  set attending(Attending attending){
    final userDoc =FirebaseFirestore.instance.collection('attendees')
...
class YesNoSelection extends StatelessWidget {
  ...
  const YesNoSelection({Key key, this.state, this.onSelection}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    switch (state){
      case Attending.yes:
